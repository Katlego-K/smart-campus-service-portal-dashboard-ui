            ...
            <SignIn.Root>
                ...
                >
                    ...
                    <Clerk.Field name="identifier" className='flex flex-col gap-2'>
                        ...
                        <Clerk.Input type="text" required className="p-2 rounded-md  ring-1 ring-1-gray-300"/>
                        <Clerk.FieldError className='text-xs text-red-400'/>
                    </Clerk.Field>
                    <Clerk.Field name="password" className='flex flex-col gap-2'>
                        <Clerk.Label className='text-xs text-gray-500'>Password</Clerk.Label>
                        <Clerk.Input type='password' required className='p-2 rounded-md ring-1  ring-1-gray-300'/>
                        <Clerk.FieldError className='text-xs text-red-400'/>
                    </Clerk.Field>
